...
target_hash = "2bce783659568191460b9ce9c40b5ce2103c5373929bc3c852ba7db3e76a6c08"

# Your cheese list
cheese_list = """Abbaye du Mont des Cats
Abertam
Ackawi
Acorn
Allgauer Emmentaler
...
# Split the list into individual cheese names
cheese_names = cheese_list.split("\n")

print(f"Total cheese names: {len(cheese_names)}")
print(f"Target hash: {target_hash}")
print("-" * 60)

found = False
for cheese in cheese_names:
    # Compute SHA-256 hash of the cheese name
    hash_result = hashlib.sha256(cheese.encode()).hexdigest()
...
if not found:
    print("❌ No individual cheese name matches the target hash.")
    print("\nNote: The target hash is for the ENTIRE list as a single string,")
    print("not for any individual cheese name.")